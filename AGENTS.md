...
This repo is demo-wasm. Preprod is Cardano. `inspect_preprod` reads Koios. Agents build unsigned txs. Wallets sign. See docs/DUAL_STACK.md.

Never give this node founder keys. See docs/RED_TEAM.md.
